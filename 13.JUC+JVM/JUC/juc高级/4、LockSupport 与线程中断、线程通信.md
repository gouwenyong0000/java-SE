...
![](4、LockSupport 与线程中断.assets/a24cb86c1e0b4fe8bae7dc767476caa7-1662477260506-1.png)
...
 ![](4、LockSupport 与线程中断.assets/296eb7006b184b2ba101e8cf81d63458-1662477260507-2.png)
...
| `public static boolean interrupted()` | 静态方法，Thread.interrupted();  <br/>判断线程是否被中断，并清除当前中断状态 这个方法做了两件事： <br/>1 返回当前线程的中断状态 <br/>2 将当前线程的中断状态设为 false，清除线程的中断状态 <br/>这个方法有点不好理解，因为连续调用两次的结果可能不一样 。 |
...
![image-20220906002314794](4、LockSupport 与线程中断.assets/image-20220906002314794-1662399718373-24-1662477260507-3.png)
...
![](4、LockSupport 与线程中断.assets/7ea99f5e35164990b8bb6610faa49636-1662477260507-4.png)
...
![](4、LockSupport 与线程中断.assets/5a1ee2b2f5df4ac5b3620bff0ebb0d27-1662477260507-5.png)
...
![](4、LockSupport 与线程中断.assets/bd1c3d8597de4150a1538a249673df46-1662477260507-10.png)

#### 静态方法与实例方法的对比

 ![](4、LockSupport 与线程中断.assets/5daed00e50174369988cebd80d7c9f5e-1662477260507-6.png)
...
![](4、LockSupport 与线程中断.assets/d4917e5f867e4e618cccfaec5023f46d-1662399718369-3-1662477260507-8.png)
...
- `unpark()`方法是**解除阻塞线程**
  ...
  ![img](4、LockSupport 与线程中断.assets/1ca493a6ed07446a90dafaef90d25d23-1662477260507-7.png)
...
![img](4、LockSupport 与线程中断.assets/b67b91fb5ce34ba0a226d1b024ea428e-1662477260507-9.png)
...
![](4、LockSupport 与线程中断.assets/ac05038a218c463893c24062039f59ae-1662477260507-11.png)
...
![](4、LockSupport 与线程中断.assets/0bb978c9fd4746c38d14b0e84184ac5b-1662477260507-13.png)
...
 ![](4、LockSupport 与线程中断.assets/4e5e6600c0494e7486926eb90464b155-1662477260507-12.png)
...
 ![](4、LockSupport 与线程中断.assets/7a8de47a0cc14cd6ad57a5a0de3b17eb-1662477260508-15.png)
...
![](4、LockSupport 与线程中断.assets/37c6b87e15634d8e97af81dd507b081e-1662477260507-14.png)
...
![](4、LockSupport 与线程中断.assets/ac7d6942c57140aea24a7b3e2ffabcad-1662477260508-16.png)
...
![](4、LockSupport 与线程中断.assets/f0b2704dedc94200ad115ccefefccac4-1662477260508-17.png)
...
![](4、LockSupport 与线程中断.assets/3aba9f6792224bcab5e9446456e4be9c-1662477260508-18.png)
...
![img](4、LockSupport 与线程中断.assets/cdd87c9b436a435ab07a2fecec304229-1662477260508-19.png)
...
![img](4、LockSupport 与线程中断.assets/d784a1d4a5e54c09a6a8258983506b29-1662477260508-20.png)
...
![](4、LockSupport 与线程中断.assets/13185c79a1744eb28c352a83e314d368-1662477260508-21.png)
...
![](4、LockSupport 与线程中断.assets/1fc1779c0b454f05b9073b75f02cc906-1662477260508-22.png)
...
![](4、LockSupport 与线程中断.assets/61ac1710aef8496a91e07ebf7ca2b24c-1662477260508-23.png)
