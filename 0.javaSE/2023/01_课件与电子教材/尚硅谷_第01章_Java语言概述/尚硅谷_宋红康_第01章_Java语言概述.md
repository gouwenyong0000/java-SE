...
| echo javase>1.txt | 将javase写出到1.txt文件中 |
...
- 类文件不在当前路径下，或者不在classpath指定路径下    详细参考：博文：Java 环境变量 PATH 和 CLASSPATH
...
步骤2：编译。针对于.java结尾的源文件进行编译操作。 格式：javac 源文件名.java  | javac -encoding utf-8 Review01.java
...
![这里写图片描述](./images/70-1668608221904-2.png)

![这里写图片描述](./images/70-1668608221905-3.png)

![这里写图片描述](./images/70-1668608221905-4.png)
