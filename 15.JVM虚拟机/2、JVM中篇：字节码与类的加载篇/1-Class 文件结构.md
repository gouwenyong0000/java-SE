...
![](images/1-Class 文件结构/836a60f4c699421e87d97e327d98aa95-1710867051812-9-1711627020487-2.png)

### 1. 概述

![](images/1-Class 文件结构/7381e11ed8924742b44b359a165a6f0b.png)

![](images/1-Class 文件结构/6d7314832be94bd5aee60bede8ec5f63.png)

#### 1.1 字节码文件的跨平台性

![](images/1-Class 文件结构/d447d7294ae847f6aeb1d29bca764ee4.png)
...
![](images/1-Class 文件结构/1a0bb79c4f474320ac529870729d5fd7.png)
...
>  **前端编译器 vs 后端编译器**
> 
> ![](images/1-Class 文件结构/3425d2bcef534e81a3f88e510279ed26.png)
...
![](images/1-Class 文件结构/7c18013d0e6a404ba7606044d7a2a202.png)

#### 解读class文件的三种方式

![](images/1-Class 文件结构/32fda020f87a46e58a620e54f8f04fc7.png)

![](images/1-Class 文件结构/80b904cbeb204b73b4705b5474bd500b.png)  
...
![](images/1-Class 文件结构/dc3c8cc9e7ec4ca8aac6ff3e308748df.png)

![](images/1-Class 文件结构/64c1320812ac47d89d683f5685560e85.png)
...
![image-20210508233536076](images/1-Class 文件结构/5c2a8d904287373990cffe9b82428daa.png)
...
![image-20240228012110562](images/1-Class 文件结构/image-20240228012110562.png)
...
![image-20210508234020104](images/1-Class 文件结构/a17ef03e0783c664a51491aafde85d2a.png)
...
![](images/1-Class 文件结构/3c2ebcd100ff43b0a7b8e20f353eb3bc.png)
...
![image-20240228011616842](images/1-Class 文件结构/image-20240228011616842.png)
...
> 解析案例：
>
> ![image-20240228012307254](images/1-Class 文件结构/image-20240228012307254.png)
>
> 对于表中第21项：
>
> 第一部分tag：01：查表表示 CONSTANT_utf8_info，UTF-8编码的字符串
>
> ![image-20240228012500223](images/1-Class 文件结构/image-20240228012500223.png)
>
...
![image-20210421235232911](images/1-Class 文件结构/412a7e52bfb1ee0aa8229db1402ae58a.png)
...
![](images/1-Class 文件结构/511776abd34b48f080f301b96fabdebe.png)

![](images/1-Class 文件结构/ccbd9ca5912c41d5b1d212572e9adc76.png)

![](images/1-Class 文件结构/a8d69d82472b4f1db5c13d906cdd78cf.png)
